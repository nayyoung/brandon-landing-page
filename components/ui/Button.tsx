...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "inline-flex items-center justify-center px-8 py-4 font-sans font-semibold transition-all duration-300 transform active:scale-95 tracking-wide text-sm uppercase";
