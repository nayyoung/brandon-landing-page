  ...
  return (
    <div className="min-h-screen bg-charcoal-900 text-white selection:bg-copper-500 selection:text-white">
      ...
      <main>
        ...
        <div id="results" className="border-y border-white/5 bg-charcoal-800/50 py-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
               <div>
                  <div className="text-3xl md:text-4xl font-display font-bold text-white mb-2">50% &rarr; 80%</div>
                  <div className="text-xs text-gray-500 uppercase tracking-widest">Occupancy Growth</div>
               </div>
               <div>
                  <div className="text-3xl md:text-4xl font-display font-bold text-white mb-2">Top 10%</div>
                  <div className="text-xs text-gray-500 uppercase tracking-widest">First Year Sales</div>
               </div>
               <div>
                  <div className="text-3xl md:text-4xl font-display font-bold text-white mb-2">Sound Transit</div>
                  <div className="text-xs text-gray-500 uppercase tracking-widest">Acquisition Agent</div>
               </div>
               <div>
                  <div className="text-3xl md:text-4xl font-display font-bold text-white mb-2">Musician</div>
